...
def plot_time_series(file_name, var_names):
    ...
    for i,var_name in enumerate(var_names):
        ...
        axs[row_index,col_index].set_title(label, fontsize=8)
...
if __name__ == "__main__":
    ...
    var_names  = [ "SWdown","Rainf","Tair","LAI", "Snowf","LWdown","Qair","Wind","PSurf",
    ...
    for i,file_name in enumerate(file_names):
        plot_time_series(file_name,var_names)
